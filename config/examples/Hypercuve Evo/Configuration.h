 ...
 *         EXP1                  
 */
//#define EXP1_03_PIN                        P1_23 // ok LED BLUE
//#define EXP1_04_PIN                        P1_22 // ok LED GREEN
//#define EXP1_05_PIN                        P1_21 // ok LED RED
//
//#define EXP1_06_PIN                        P1_20 //lcd 4 (E))
//#define EXP1_07_PIN                        P1_19 //lcd RS (CS)
//#define EXP1_08_PIN                        P1_18 //lcd E (RW)
//#define EXP1_09_PIN                        P0_28 //btn ENC
//#define EXP1_10_PIN                        P1_30 //beep
...
#define STRING_CONFIG_H_AUTHOR "(Hipercube EVO)" // Who made the changes.
...
#define MAX_BED_POWER 191 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 37.0025 //MESA 750W 220V
  #define DEFAULT_bedKi 7.0548
  #define DEFAULT_bedKd 129.3856
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 3200, 410 } //x*32, y*32, z*16, e0*16, e1*
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 25, 5000 }
...
#define Z_SERVO_ANGLES { 60, 0 } // Z Servo Deploy and Stow angles
...
#define Z_PROBE_FEEDRATE_SLOW (6*60)//(Z_PROBE_FEEDRATE_FAST / 2)
...
#define Z_AFTER_HOMING  11      // (mm) Height to move to after homing Z
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define ENABLE_LEVELING_FADE_HEIGHT
    ...
    #define DEFAULT_LEVELING_FADE_HEIGHT 6 // (mm) Default fade height.
  #endif
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 150), (Y_MAX_POS - 10), 20 }
...
#define NEOPIXEL_LED
  ...
  //#define NEOPIXEL2_TYPE NEO_GBR// NEOPIXEL_TYPE
  //#define NEOPIXEL2_PIN    P1_00 // P1_00 'PWRDET'
